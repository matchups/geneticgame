...
class GeneticOverride (geneticgame.GeneticGame):
    ...
    def log (self):
        if self.gen % 5 == 0:
            global totcount
            print (f"G={self.gen}, A={totcount / self.parms['matches_per_round']}")
        totcount = 0
...
ret = gg.optimize ()
print ("""Key:
    Logger shows G=generation A=average static evaluation of players
    Evaluation shows E=score for this round A=average for last Ten
    """)
print ('--Final results--')
print (ret)
